...
- **High Confidence & Sensitivity Threshold**:
  - Be **highly conservative** and less sensitive when editing `Assistant.md`. Do NOT update it for temporary requests or instructions meant only for the current turn/chat (e.g., "explain this briefly", "reply in Portuguese for now", "summarize this text").
